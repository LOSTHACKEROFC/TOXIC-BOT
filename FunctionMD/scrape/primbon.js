...
const cheerio = require('cheerio')
    ...
    async function nomer_hoki(nomor) {
    ...
    async function ramalan_jodoh(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function ramalan_jodoh_bali(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function suami_istri(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function ramalan_cinta(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function arti_nama(value) {
        return new Promise((resolve, reject) => {
    ...
    async function kecocokan_nama(nama, tgl, bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function kecocokan_nama_pasangan(nama1, nama2) {
        return new Promise((resolve, reject) => {
    ...
    async function tanggal_jadian_pernikahan(tgl, bln, thn) {
        return new Promise((resolve, reject) => {
    ...
    async function pekerjaan_weton_lahir(tgl, bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function ramalan_nasib(tgl, bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function cek_potensi_penyakit(tgl, bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function arti_kartu_tarot(tgl, bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function perhitungan_feng_shui(nama, gender, tahun) {
        /**
    ...
    async function petung_hari_baik(tgl, bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function hari_sangar_taliwangke(tgl, bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function primbon_hari_naas(tgl, bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function rahasia_naga_hari(tgl,bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function primbon_arah_rejeki(tgl, bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function ramalan_peruntungan(nama, tgl, bln, thn, untuk) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function sifat_karakter_tanggal_lahir(nama, tgl, bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function primbon_memancing_ikan(tgl, bln, thn) {
        return new Promise((resolve, reject) => {
            axios({
    ...
    async function masa_subur(dateday, datemonth, dateyear, siklus = "28") {
        return new Promise((resolve, reject) => {
            axios({
